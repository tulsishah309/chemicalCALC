...
def Addition(x,y):
  ...
  return s,reactions,ans,historyTable.values.tolist(),varAddition
...
def Substraction(x,y):
  ...
  return s,reactions,ans,historyTable.values.tolist(),varSubstraction
...
def Division(x,y):
  ...
  return s,reactions,quotient,historyTabel.values.tolist(),varDivision
...
def Multiplication(x,y):
  ...
  return s,reactions,ans,historyTable.values.tolist(),varMultiplication
    ...
    while i < len(tokens):
        ...
        # solve entire brace.
            ...
            while len(ops) != 0 and ops[-1] != '(':
                ...
                op = ops.pop()
                s,res,ans,his,var = applyOp(val1, val2, op)
                S.append(s)
